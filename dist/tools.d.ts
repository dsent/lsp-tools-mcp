import type { Diagnostic, DocumentSymbol, Location, LocationLink, PrepareRenameDefaultBehavior, PrepareRenameResult, Range, SeverityFilter, SymbolInfo, WorkspaceEdit } from "./lsp/types.js";
...
export declare function executeLspDiagnostics(params: Record<string, unknown>, signal?: AbortSignal): Promise<ToolExecutionResult>;
export declare function executeLspTool(name: string, params: Record<string, unknown>, signal?: AbortSignal): Promise<ToolExecutionResult>;
export declare function coerceToolArguments(value: unknown): Record<string, unknown>;
export declare const LSP_MCP_TOOLS: LspMcpTool[];
